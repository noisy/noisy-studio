...
def _grok_tts(options=None) -> TTSProvider:
    from noisy_studio.providers.grok import GrokTTS
...
def _local_stt(options=None) -> STTProvider:
    from noisy_studio.providers.local import LocalSTT
...
def catalog() -> list[dict]:
    ...
    from noisy_studio.providers.manifest import catalog as _catalog
